...
import static net.defekt.code.minelite.core.data.DataTypes.writeString;
import static net.defekt.code.minelite.core.data.DataTypes.writeVarInt;
...
import net.defekt.code.minelite.core.data.StatusResponse;
