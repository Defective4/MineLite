...
import io.github.defective4.minelite.v1_12_2.protocol.packets.clientbound.login.ServerLoginDisconnectPacket;
import io.github.defective4.minelite.v1_12_2.protocol.packets.clientbound.login.ServerLoginSuccessPacket;
import io.github.defective4.minelite.v1_12_2.protocol.packets.clientbound.play.ServerBossBarPacket;
...
import io.github.defective4.minelite.v1_12_2.protocol.packets.clientbound.play.ServerStatisticsPacket;
 ...
 *
 */
public class PacketRegistry_1_12_2 extends PacketRegistry {
        ...
        return new ConcurrentHashMap<Integer, Class<? extends InPacket>>() {
            {
                ...
                put(0x40, ServerUpdateExperiencePacket.class);
                put(0x2e, ServerPlayerInfoPacket.class);
                put(0x07, ServerStatisticsPacket.class);
                put(0x0C, ServerBossBarPacket.class);
            }
        };
    }
